...
import com.study.domain.MyBean257Product;
import com.study.domain.MyBean261OrderList;
...
public class Controller26 {
    ...
    public String sub1(String start, String end, Model model) throws SQLException {
        // todo : 메소드 작성하세요.
        var list = new ArrayList<MyBean261OrderList>();
        //  between 활용
        String sql = """
                SELECT *
                FROM Orders
        ...
        try (conn; pstmt; rs;) {
            while (rs.next()) {
                MyBean261OrderList obj = new MyBean261OrderList();
...
//            ----------------------------------------------
            ...
            var productList = new ArrayList<MyBean257Product>();
            try (resultSet; pstmt;) {

                while (resultSet.next()) {
                    MyBean257Product p = new MyBean257Product();
