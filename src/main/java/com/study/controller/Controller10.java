...
public class Controller10 {
    ...
    public void method7(Model model) {
        ...
        e1.setModelName("Benz");
        e1.setPrice(300000000);
        e1.setColor("Black");

        e2.setModelName("Matiz");
        e2.setPrice(200000000);
        e2.setColor("White");

        e3.setModelName("Starex");
        e3.setPrice(250000000);
        e3.setColor("Silver");
    ...
    public void method9(Model model) {
        var food = new ArrayList<MyBean104>();
        MyBean104 e1 = new MyBean104();
        MyBean104 e2 = new MyBean104();
        MyBean104 e3 = new MyBean104();

        e1.setCity("서울");
        e1.setFoods(List.of("김치", "비빔밥", "불고기"));


        e2.setCity("도쿄");
        e2.setFoods(List.of("스시", "오코노미야끼", "타다끼"));


        food.add(e1);
        food.add(e2);
        food.add(e3);
        model.addAttribute("data", food);
